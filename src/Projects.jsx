    ...
    return (
      ...
      <div className='projects-wrapper'>
        <div className='project'>
          <a href="https://hpsaglobal.net/#" target="_blank" rel="noopener noreferrer">
            <img className='images' src={medical} alt='' />
          </a>
          <div className='project-info'>
            <div className='project-title'>
              <h2>Health Policy Student Association</h2>
              <div className='liness'></div>
              <a href="https://github.com/ChrisMikhail/hpsa-website" target="_blank" rel="noopener noreferrer">
          ...
          <div className='project'>
            ...
            <div className='project-info'>
              <div className='project-title'>
                ...
                <div className='liness'></div>
                 <a href="https://github.com/HNow/MetHacks2023Base"  target="_blank" ><FontAwesomeIcon icon={faGithub} size="2x" /> </a>
              </div>
          ...
          <div className='project'>
            ...
            <div className='project-info'>
              <div className='project-title'>
                ...
                <div className='liness'></div>
                <a href="https://github.com/Octrainn/React-Calendar-App "  target="_blank" ><FontAwesomeIcon icon={faGithub} size="2x" /> </a>
          ...
          <div className='project'>
            ...
            <div className='project-info'>
              <div className='project-title'>
                ...
                <div className='liness'></div>
                <a href="https://github.com/Octrainn/DiscordBot " target='_blank'><FontAwesomeIcon icon={faGithub} size="2x" /> </a>
              </div>
          ...
          <div className='project'>
            ...
            <div className='project-info'>
              <div className='project-title'>
                ...
                <div className='liness'></div>
                 <a href=" https://github.com/Octrainn/TensorFlowModel" target='_blank'><FontAwesomeIcon icon={faGithub} size="2x" /> </a>
              </div>
